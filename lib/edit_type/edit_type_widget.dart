...
class EditTypeWidget extends StatefulWidget {
  const EditTypeWidget({
    ...
    this.state3,
    String? typeName,
  })  : this.initState = initState ?? 'Initial State',
        this.stateName = stateName ?? 'Init',
        this.state2 = state2 ?? 'State 2',
    ...
    return StreamBuilder<List<TypeRecord>>(
      stream: queryTypeRecord(
        queryBuilder: (typeRecord) =>
            typeRecord.where('typeName', isEqualTo: widget.typeName),
      ),
      builder: (context, snapshot) {
        ...
        List<TypeRecord> editTypeTypeRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 0.0),
                          child: Text(
                            'Add users, states, and actions for your newly created type. \n\nSelect the state to change the name and add action items. \n\nSelect \"Create State\" to add a new state to the type.',
                          ...
                          child: InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditStateWidget(),
                                ),
                              );
                            },
                            child: Container(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await ActionsRecord.createDoc(
                                        editTypeTypeRecordList.first.reference)
