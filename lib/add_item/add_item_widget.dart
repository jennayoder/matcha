                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Select a collection to add the item to.',
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<TypeRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TypeRecord> dropDownTypeRecordList =
                                snapshot.data!;
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            10.0, 0.0, 10.0, 0.0),
                        child: FutureBuilder<List<ScannedItemsRecord>>(
                          future: queryScannedItemsRecordOnce(
                            queryBuilder: (scannedItemsRecord) =>
                                scannedItemsRecord.where('qrID',
                                    isEqualTo: widget.scannedItem),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            ...
                            List<ScannedItemsRecord>
                                textScannedItemsRecordList = snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final textScannedItemsRecord =
                                textScannedItemsRecordList.isNotEmpty
                                    ? textScannedItemsRecordList.first
                                    : null;
                            return Text(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final textScannedItemsRecord =
                                textScannedItemsRecordList.isNotEmpty
                                    ...
                                    : null;
                            return Text(
                              'You can add this item to a collection anyways or view this item\'s status',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyText1
                                  .override(
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => ItemDisplayWidget(
                                      types:
                                          typeItemScannedItemsRecord!.typeRef,
                                    ),
                                  ),
                                );
                              },
